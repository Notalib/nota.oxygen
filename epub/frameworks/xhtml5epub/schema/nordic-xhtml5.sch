...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
    ...
    <pattern id="epub_nordic_13_a">
        ...
        <rule context="html:body[html:header or matches(base-uri(), 'concat\.xhtml$')]">
    ...
    <pattern id="epub_nordic_13_b">
        <rule context="html:*[self::html:section or self::html:article][ancestor::html:body[html:header or matches(base-uri(), 'concat\.xhtml$')] and not(parent::html:body) and not(parent::html:section[tokenize(@epub:type,'\s+')='part'])]">
    ...
    <pattern id="epub_nordic_13_c">
        <rule context="html:body[not((html:header|html:nav) or matches(base-uri(), 'concat\.xhtml$'))]">
    ...
    <pattern id="epub_nordic_13_d">
        <rule context="html:*[self::html:section or self::html:article][ancestor::html:body[not((html:header|html:nav) or matches(base-uri(), 'concat\.xhtml$'))]]">
    ...
    <pattern id="epub_nordic_14">
        <rule
            context="html:*[self::html:body[not(html:header or matches(base-uri(), 'concat\.xhtml$'))] or self::html:section or self::html:article][not(tokenize(@epub:type,'\s+')='cover')][html:section[not(tokenize(@epub:type,'\t+')=('z3998:poem','z3998:verse'))]|html:article]">
    ...
    <pattern id="epub_nordic_15">
        <!-- see also nordic2015-1.opf-and-html.sch for multi-document version -->
        <rule context="html:body[html:header or matches(base-uri(), 'concat\.xhtml$')]/html:*[self::html:section or self::html:article]">
    ...
    <pattern id="epub_nordic_26_a">
        <rule context="html:*[ancestor::html:body[html:header or matches(base-uri(), 'concat\.xhtml$')] and tokenize(@epub:type,'\s+')=('note','rearnote','footnote')]">
    ...
    <pattern id="epub_nordic_26_b">
        <rule context="html:a[ancestor::html:body[html:header or matches(base-uri(), 'concat\.xhtml$')] and tokenize(@epub:type,'\s+')='noteref']">
            <!-- this is the single-HTML version of the rule; the multi-HTML version of this rule is in nordic2015-1.opf-and-html.sch -->
    ...
    <pattern id="epub_nordic_27_a">
        <rule context="html:*[ancestor::html:body[html:header or matches(base-uri(), 'concat\.xhtml$')] and tokenize(@epub:type,' ')='annotation']">
            <!-- this is the single-HTML version of the rule; the multi-HTML version of this rule is in nordic2015-1.opf-and-html.sch -->
    ...
    <pattern id="epub_nordic_27_b">
        <rule context="html:a[ancestor::html:body[html:header or matches(base-uri(), 'concat\.xhtml$')] and tokenize(@epub:type,'\s+')='annoref']">
            <!-- this is the single-HTML version of the rule; the multi-HTML version of this rule is in nordic2015-1.opf-and-html.sch -->
    ...
    <pattern id="epub_nordic_269">
        <rule context="html:body[not(html:header or matches(base-uri(), 'concat\.xhtml$'))]">
    ...
    <pattern id="epub_nordic_272">
        <rule context="html:a[tokenize(@epub:type,'\s+')='annoref']">
            <assert test="contains(@href, '#')">[nordic272a] Note reference href attribute does not contain a fragment identifier: <value-of
                    select="concat('&lt;',name(),string-join(for $a in (@*) return concat(' ',$a/name(),'=&quot;',$a,'&quot;'),''),'&gt;')"/></assert>
            <report test="ancestor::html:body[html:header or matches(base-uri(), 'concat\.xhtml$')] and contains(@href, '#') and substring-after(@href, '#')=//html:*[tokenize(@epub:type,'\s+')=('annotation')]/@id">[nordic272b] Annotation
    ...
    <pattern id="epub_nordic_275">
        <rule context="html:img[@longdesc and ancestor::html:body[html:header or matches(base-uri(), 'concat\.xhtml$')]]">
