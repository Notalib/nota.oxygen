...
book
  ...
  <xsl:template match="book">
    <body>
      ...
      <!--
      <div class="kolofon">
        <h1>Her slutter bogens tekst</h1>
        <p>Indlæst af:</p>
      </div>-->
...
td
============================================================================== -->
  <!-- ændret 25-01-2012 med henblik på at gøre hele tabeller til navigationspunkter -->
...
th
	============================================================================== -->
  <!-- Ændret 25-01-2011 med henblik på at gøre table til navigationspunkt -->
